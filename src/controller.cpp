...
int main(int argc, char **argv)
{
    ...
    sync.registerCallback(boost::bind(&callback, 1, 2, 3)(storage, ack_service, service_client); // boost::bind() allows to pass arguments to a callback. E.g. a map<int, string> 
