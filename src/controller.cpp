...
class Controller
{
    public:
        ...
        Controller() : sync(img_subscriber, int_subscriber, 10)
        {
            ...
            sync.registerCallback(boost::bind(&Controller::callback, boost::shared_ptr<sensor_msgs::ImageConstPtr, imagineer::Number>, _1, _2)); // boost::bind() allows to pass arguments to a callback.  
        }
