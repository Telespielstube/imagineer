...
class NeuralNetwork(nn.Module):
    ...
    def __init__(self):
        ...
        self.input_layer = nn.Sequential(nn.Linear(28 * 28, 512)) #first layer has 784 input values (pixels), and 512 output values
        self.hidden_layer1 = nn.Linear(512, 254)
        self.hidden_layer2 = nn.Linear(254, 128)
        self.hidden_layer3 = nn.Linear(128, 64)
        self.output_layer = nn.Linear(64, 10) # output size is 10, because we expect a number from 0 to 9.
